...
- $\alpha$ controls the lateral-to-vertical etching ratio  
...
Simulation performed on $600 \times 600 \times 600$ grid ($\Delta t = 1\,\text{s}$). Results at $t = 60\,\text{s}$ compared against SEMulator3D. Hardware: Linux server with Intel® Xeon® Gold 6230R CPU @ 2.10 GHz.
