...
\phi_L = 
\begin{cases} 
  \displaystyle \frac{6\phi_{i-1} + 3\phi_i - \phi_{i-2}}{8} & U_f \geq 0 \\
  \displaystyle \frac{6\phi_i + 3\phi_{i-1} - \phi_{i+1}}{8} & U_f < 0 
\end{cases}
$$
...
\phi_R = 
\begin{cases} 
  \displaystyle \frac{6\phi_i + 3\phi_{i+1} - \phi_{i-1}}{8} & U_f \geq 0 \\
  \displaystyle \frac{6\phi_{i+1} + 3\phi_i - \phi_{i+2}}{8} & U_f < 0 
\end{cases}
$$
...
$$
\psi(r) = \frac{r + |r|}{1 + |r|}, \quad 
r = \frac{\phi_i - \phi_{i-1}}{\phi_{i+1} - \phi_i + \epsilon}
$$
